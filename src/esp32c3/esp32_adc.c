...
static struct esp32_adc_channel_info s_chans[8] = {
    {.pin = 0, .ch = ADC1_CHANNEL_0, .atten = ADC_ATTEN_DB_11},
    {.pin = 1, .ch = ADC1_CHANNEL_1, .atten = ADC_ATTEN_DB_11},
    {.pin = 2, .ch = ADC1_CHANNEL_2, .atten = ADC_ATTEN_DB_11},
    {.pin = 3, .ch = ADC1_CHANNEL_3, .atten = ADC_ATTEN_DB_11},
    {.pin = 4, .ch = ADC1_CHANNEL_4, .atten = ADC_ATTEN_DB_11},
};
...
void esp32_adc_set_width(int width) {
  if ((width >= 0) && (width <= ADC_WIDTH_12Bit)) {
    s_width = width;
  }
