...
static struct esp32_adc_channel_info s_chans[8] = {
    {.pin = 36, .ch = ADC_CHANNEL_0, .atten = ADC_ATTEN_DB_12},
    {.pin = 37, .ch = ADC_CHANNEL_1, .atten = ADC_ATTEN_DB_12},
    {.pin = 38, .ch = ADC_CHANNEL_2, .atten = ADC_ATTEN_DB_12},
    {.pin = 39, .ch = ADC_CHANNEL_3, .atten = ADC_ATTEN_DB_12},
    {.pin = 32, .ch = ADC_CHANNEL_4, .atten = ADC_ATTEN_DB_12},
    {.pin = 33, .ch = ADC_CHANNEL_5, .atten = ADC_ATTEN_DB_12},
    {.pin = 34, .ch = ADC_CHANNEL_6, .atten = ADC_ATTEN_DB_12},
    {.pin = 35, .ch = ADC_CHANNEL_7, .atten = ADC_ATTEN_DB_12},
};
...
static bool esp32_update_channel_settings(struct esp32_adc_channel_info *ci) {
  ...
  adc_cali_line_fitting_config_t sconfig;
  ...
  adc_cali_create_scheme_line_fitting(&sconfig, &ci->cali_h);
